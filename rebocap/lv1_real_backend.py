...
JOINTS: dict[tuple[str, int], str] = {
    ...
    ("can0", 6): "right_wrist_yaw_motor_joint",
    ("can0", 7): "right_wrist_pitch_joint",
    ...
    ("can1", 6): "left_wrist_yaw_motor_joint",
    ("can1", 7): "left_wrist_pitch_joint",
...
JOINT_KPKD: dict[str, tuple[float, float]] = {
    ...
    **{
        f"{side}_{joint}_joint": (2.943826643921725, 0.18740982479430696)
        for side in ("right", "left")
        for joint in ("wrist_yaw_motor", "wrist_pitch")
    },
...
JOINT_TARGET: dict[str, float] = {
    ...
    "right_wrist_yaw_motor_joint": 0.0,
    ...
    "left_wrist_yaw_motor_joint": 0.0,
